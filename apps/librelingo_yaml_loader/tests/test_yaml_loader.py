...
Phrases:
    - Phrase: {kwargs["fake_phrase_phrase"]}
      Translation: {kwargs["fake_phrase_translation"]}
Mini-dictionary:
  {kwargs["word3"]}:
  ...
  English:
    ...
    def get_fake_values(self):
        return {
            ...
            "fake_phrase_phrase": fakes.fake_string(),
            "fake_phrase_translation": fakes.fake_string(),
