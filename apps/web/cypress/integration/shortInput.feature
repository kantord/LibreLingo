Feature: Short text input challange
  ...
  Scenario: Getting a short text input challenge
    Given I open "/course/test/skill/short-input-test-0?testChallenge=shortInput"
    Then short text input challenge looks correct
    And I read "Type"
    And I read "dog"
    And I read "in Test Language!"
    Given I open "/course/test/skill/short-input-test-1?testChallenge=shortInput"
    Then I read "foo"
  ...
  Scenario: Going to the next challenge
    Given I open "/course/test/skill/short-input-test-2?testChallenge=shortInput"
    And I type "agua"
    And I click "Submit"
  ...
  Scenario: using the hover-over dictionary
    Given I open "/course/test/skill/short-input-test-3?testChallenge=shortInput"
