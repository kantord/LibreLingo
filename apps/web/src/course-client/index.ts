import { getMarkDownData } from "../../src/components/MarkDownPage.svelte"
...
export const get_course = async ({ courseName }: { courseName: string }): CourseDataType => {
        ...
        for (const skill of module.skills) {
            if (skill.practiceHref === skillName) {
                return {
                    ...
                    readmeHTML: await getMarkDownData(require(`../courses/${courseName}/introduction/${skill.introduction}`))
                }
            }
        }
    }
