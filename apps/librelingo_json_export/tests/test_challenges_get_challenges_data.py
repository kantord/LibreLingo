...
@pytest.fixture
def mock_get_skill_challenges(mocker):
    return mocker.patch("librelingo_json_export.challenges._make_skill_challenges")
...
def test_returns_correct_challenges(
    mock_get_phrase_challenges, mock_get_word_challenges, mock_get_skill_challenges
):
    ...
    mock_get_skill_challenges.return_value = [fakes.challenge5, fakes.challenge6]
