...
from librelingo_tools.data_types import Module, Language
...
class TestExportCourseSkills(FakeFsTestCase):
    ...
    @patch('librelingo_tools.export.export_skill')
...
class TestExportSkill(FakeFsTestCase):
    ...
    @patch('librelingo_tools.export.get_skill_data')
...
class TestExportCourseData(FakeFsTestCase):
    ...
    @patch('librelingo_tools.export.get_course_data')
