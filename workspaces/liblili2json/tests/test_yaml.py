...
class TestLoadCourseMeta(FakeFsTestCase):
    ...
    def setUp(self):
        ...
        self.fake_values = {
            "target_language_name": "Nonexistian",
    ...
    def test_returns_correct_language_name(self):
        ...
        self.customize(
            target_language_name=fake_name
        )
        assert self.result.target_language.name == fake_name

    def test_returns_correct_language_code(self):
        fake_code = str(fakes.fake_value())
        self.customize(
            target_language_code=fake_code
        )
        assert self.result.target_language.code == fake_code

    def test_returns_correct_source_language_name(self):
        fake_name = str(fakes.fake_value())
        self.customize(
            source_language_name=fake_name
        )
        assert self.result.source_language.name == fake_name

    def test_returns_correct_source_language_code(self):
        fake_code = str(fakes.fake_value())
        self.customize(
            source_language_code=fake_code
        )
        assert self.result.source_language.code == fake_code
