...
You can use librelingo-json-export to load YAML-based LibreLingo courses in your
Python program.
...
[librelingo-json-export](https://pypi.org/project/librelingo-json-export/) is a Python 🐍 package that contains modules that help
